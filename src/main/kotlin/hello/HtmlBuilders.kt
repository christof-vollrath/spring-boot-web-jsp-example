...
open class SingletonTag(name: String): Tag(name) {
...
class Meta(): SingletonTag("meta")

fun html(lang: String, init: Html.() -> Unit): Html = Html().apply(init).set("lang", lang)
fun Html.meta(name: String, content: String): Meta = doInit(Meta().set("name", name).set("content", content), {})
